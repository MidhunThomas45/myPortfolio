...
const Comment = memo(({ comment, formatDate, index }) => (
    <div 
        className="px-4 pt-4 pb-2 rounded-xl bg-card border border-card hover:bg-cardHover transition-all group hover:shadow-lg hover:-translate-y-0.5"
        ...
        <div className="flex items-start gap-3 ">
            ...
            <div className="flex-grow min-w-0">
                <div className="flex items-center justify-between gap-4 mb-2">
                    <h4 className="font-medium text-primaryText truncate">{comment.userName}</h4>
                    <span className="text-xs text-secondaryText whitespace-nowrap">
                        {formatDate(comment.createdAt)}
                    </span>
                </div>
                <p className="text-secondaryText text-sm break-words leading-relaxed relative bottom-2">{comment.content}</p>
            </div>
        </div>
    </div>
));
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2" data-aos="fade-up" data-aos-duration="1000">
                ...
                <input
                    ...
                    className="w-full p-3 rounded-xl bg-transparent border border-white/20 text-primaryText placeholder-secondaryText focus:outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 transition-all"
                    required
                />
            </div>
            ...
            <div className="space-y-2" data-aos="fade-up" data-aos-duration="1200">
                ...
                <textarea
                    ...
                    className="w-full p-4 rounded-xl bg-transparent border border-white/20 text-primaryText placeholder-secondaryText focus:outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 transition-all resize-none min-h-[120px]"
                    required
                />
            </div>
            ...
            {/* <div className="space-y-2" data-aos="fade-up" data-aos-duration="1400">
                <label className="block text-sm font-medium text-primaryText">
                    Profile Photo <span className="text-secondaryText">(optional)</span>
                </label>
                <div className="flex items-center gap-4 p-4 bg-card border border-card rounded-xl">
                    {imagePreview ? (
                        ...
                        <div className="w-full" >
                            ...
                            <p className="text-center text-secondaryText text-sm mt-2">
                                Max file size: 5MB
                            </p>
                        </div>
                    )}
            ...
            <button
                ...
                className="relative w-full h-12 bg-gradient-to-r from-[#c9a227] to-[#f2e8d8] rounded-xl font-medium text-primaryText overflow-hidden group transition-all duration-300 hover:scale-[1.02] hover:shadow-lg active:scale-[0.98] disabled:opacity-50 disabled:hover:scale-100 disabled:cursor-not-allowed"
            >
...
const Komentar = () => {
    ...
    return (
        ...
        <div className="p-6 border-b border-card" data-aos="fade-down" data-aos-duration="800">
            ...
            <div className="space-y-4 h-[300px] overflow-y-auto custom-scrollbar" data-aos="fade-up" data-aos-delay="200">
                {comments.length === 0 ? (
                    <div className="text-center py-8" data-aos="fade-in">
                        ...
                        <p className="text-secondaryText">No comments yet. Start the conversation!</p>
                    </div>
                ) : (
